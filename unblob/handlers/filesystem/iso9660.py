...
def calculate_chunk(
    ...
    cparser.endian = "<"
    header = cparser.iso9660_pvd_t(file)
    ...
    # We need to substract the system area given that we matched on volume descriptor, which is the
    # first struct afterward.
    real_start_offset = start_offset - 0x00008000
